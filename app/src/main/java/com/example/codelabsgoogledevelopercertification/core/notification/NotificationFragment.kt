...
import com.example.codelabsgoogledevelopercertification.databinding.FragmentNotificationBinding
...
class NotificationFragment : Fragment(R.layout.fragment_notification) {
    ...
    private fun sendNotification() {
        ...
        createNotificationAction(builder, NOTIFICATION_ID, ACTION_CANCEL, "Remova")
